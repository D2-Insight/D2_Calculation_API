...
pub(super) fn dmr_paracausal_shot(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn sbr_hunters_trance(_input: ModifierResponsInput) -> HashMap<u32, i32> {
...
pub(super) fn rsmr_hunters_trance(_input: ModifierResponsInput) -> ReloadModifierResponse {
    let inter_val = *_input.calc_data.perk_value_map.get(&213689231).unwrap_or(&0);
    let buff_val = (clamp(inter_val, 0, 7) * 5) as i32;
...
pub(super) fn rmr_hunters_trance(_input: ModifierResponsInput) -> RangeModifierResponse {
    let inter_val = *_input.calc_data.perk_value_map.get(&213689231).unwrap_or(&0);
    let buff_val = (clamp(inter_val, 0, 7) * 5) as i32;
...
pub(super) fn hmr_hunters_trance(_input: ModifierResponsInput) -> HandlingModifierResponse {
    let inter_val = *_input.calc_data.perk_value_map.get(&213689231).unwrap_or(&0);
    let buff_val = (clamp(inter_val, 0, 7) * 5) as i32;
...
pub(super) fn dmr_momento_mori(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_buff = 1.0;
...
pub(super) fn dmr_agers_call(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_buff = 1.0;
...
pub(super) fn mmr_agers_call(_input: ModifierResponsInput) -> MagazineModifierResponse {
...
pub(super) fn sbr_roadborn(_input: ModifierResponsInput) -> HashMap<u32, i32> {
    let mut out = HashMap::new();
    if _input.value > 0 {
...
pub(super) fn dmr_roadborn(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn fmr_roadborn(_input: ModifierResponsInput) -> FiringModifierResponse {
...
pub(super) fn rmr_roadborn(_input: ModifierResponsInput) -> RangeModifierResponse {
...
pub(super) fn rsmr_roadborn(_input: ModifierResponsInput) -> ReloadModifierResponse {
    let mut reload = 0;
    if _input.value > 0 {
        reload = 40;
    };
...
// pub(super) fn fmr_rat_pack(_input: CalculationInput, _input.value: i32, is_enhanced: bool, _pvp: bool) -> FiringModifierResponse {
...
pub(super) fn fmr_reign_havoc(_input: ModifierResponsInput) -> FiringModifierResponse {
    let mut delay_mult = 1.0;
...
pub(super) fn edr_reign_havoc(_input: ModifierResponsInput) -> ExtraDamageResponse {
...
pub(super) fn dmr_worms_hunger(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn dmr_lagragian_sight(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_buff = 1.0;
...
pub(super) fn dmr_tom(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_buff = 1.0;
    if _input.calc_data.curr_mag == 1.0 {
        damage_buff = 2.0;
    };
...
pub(super) fn refund_tom(_input: ModifierResponsInput) -> RefundResponse {
    RefundResponse {
...
pub(super) fn edr_rocket_tracers(_input: ModifierResponsInput) -> ExtraDamageResponse {
...
pub(super) fn fmr_hakke_heavy_burst(_input: ModifierResponsInput) -> FiringModifierResponse {
    FiringModifierResponse {
        burst_size_add: -2.0,
...
pub(super) fn dmr_hakke_heavy_burst(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn dmr_swooping_talons(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn dmr_ignition_trigger(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut dmg_mult = 1.0;
...
pub(super) fn dmr_vex_catalyst(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn fmr_ravenous_beast(_input: ModifierResponsInput) -> FiringModifierResponse {
    if _input.value > 0 {
        FiringModifierResponse {
...
pub(super) fn dmr_ravenous_beast(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn sbr_release_the_wolves(_input: ModifierResponsInput) -> HashMap<u32, i32> {
...
pub(super) fn rsmr_release_the_wolves(_input: ModifierResponsInput) -> ReloadModifierResponse {
    let has_cat = _input.calc_data.perk_value_map.contains_key(&431220296);
...
pub(super) fn fmr_release_the_wolves(_input: ModifierResponsInput) -> FiringModifierResponse {
    if _input.value > 0 {
        FiringModifierResponse {
...
pub(super) fn dmr_release_the_wolves(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn sbr_fundamentals(_input: ModifierResponsInput) -> HashMap<u32, i32> {
...
pub(super) fn hmr_fundamentals(_input: ModifierResponsInput) -> HandlingModifierResponse {
    let mut handling = 0;
    if _input.value == 3 {
        handling = 25;
    }
...
pub(super) fn rsmr_fundamentals(_input: ModifierResponsInput) -> ReloadModifierResponse {
    let mut reload = 0;
    if _input.value == 2 {
        reload = 35;
    }
...
pub(super) fn rmr_fundamentals(_input: ModifierResponsInput) -> RangeModifierResponse {
    let mut range = 0;
    if _input.value == 3 {
        range = 5;
    }
...
pub(super) fn sbr_thin_the_herd(_input: ModifierResponsInput) -> HashMap<u32, i32> {
    let mut out = HashMap::new();
    if _input.value > 0 {
...
pub(super) fn rsmr_thin_the_herd(_input: ModifierResponsInput) -> ReloadModifierResponse {
    if _input.value > 0 {
        ReloadModifierResponse {
            reload_stat_add: 70,
            ..Default::default()
...
pub(super) fn hmr_chimera(_input: ModifierResponsInput) -> HandlingModifierResponse {
    if _input.value > 0 {
        HandlingModifierResponse {
            stat_add: 100,
            ..Default::default()
...
pub(super) fn sbr_chimera(_input: ModifierResponsInput) -> HashMap<u32, i32> {
    let mut out = HashMap::new();
    if _input.value > 0 {
        out.insert(StatHashes::RELOAD.into(), 100);
    }
...
pub(super) fn dmr_first_glance(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_mult = 1.0;
    let mut crit_mult = 1.0;
    if _input.value > 0 {
...
pub(super) fn dmr_fate_of_all_fools(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_mult = 1.0;
    let mut crit_mult = 1.0;
...
pub(super) fn dmr_honed_edge(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_mult = 1.0;
...
pub(super) fn dmr_taken_predator(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_mult = 1.0;
...
pub(super) fn dmr_markov_chain(_input: ModifierResponsInput) -> DamageModifierResponse {
...
pub(super) fn dmr_storm_and_stress(_input: ModifierResponsInput) -> DamageModifierResponse {
    let mut damage_mult = 1.0;
    if _input.value > 0 {
...
pub(super) fn rmr_dual_speed_receiver(_input: ModifierResponsInput) -> RangeModifierResponse {
...
pub(super) fn sbr_dual_speed_receiver(_input: ModifierResponsInput) -> HashMap<u32, i32> {
    let mut out = HashMap::new();
    if _input.value > 0 {
...
pub(super) fn dmr_full_stop(_input: ModifierResponsInput) -> DamageModifierResponse {
    DamageModifierResponse {
        explosive_dmg_scale: 1.0,
        impact_dmg_scale: 1.0,
...
pub(super) fn fmr_rat_pack(_input: ModifierResponsInput) -> FiringModifierResponse {
    let val;
    if _input.value > 0 {
...
pub(super) fn mmr_rat_pack(_input: ModifierResponsInput) -> MagazineModifierResponse {
...
pub(super) fn fmr_ride_the_bull(_input: ModifierResponsInput) -> FiringModifierResponse {
...
pub(super) fn fmr_spinning_up(_input: ModifierResponsInput) -> FiringModifierResponse {
...
// pub(super) fn dmr_noble_rounds(_input: ModifierResponsInput) -> DamageModifierResponse {
//     if _input.value > 0 {
