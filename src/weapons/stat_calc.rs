...
impl Weapon {
    pub fn calc_firing_data(
        ...
        let base = (fd.burst_delay + firing_modifiers.burst_delay_add) * firing_modifiers.burst_delay_scale;
        let burst_delay= if self.weapon_type == WeaponType::BOW && base < 0.5 { 0.5 } else { base };
